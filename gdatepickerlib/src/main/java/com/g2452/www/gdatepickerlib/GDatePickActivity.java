package com.g2452.www.gdatepickerlib;
...
public class GDatePickActivity  extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_gdate_pick);
    ...
    public void onClick(View v) {
        int i = v.getId();
        if (i == R.id.ll_date) {// 日期格式为yyyy-MM-dd
            mDatePicker.show(mTvSelectedDate.getText().toString());

        } else if (i == R.id.ll_time) {// 日期格式为yyyy-MM-dd HH:mm
